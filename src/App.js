...
function createItemForCart(productID, name, price) {
    ...
    inputAmount.addEventListener('change', (event) => {
        onChangePrice(event, pPrice.id, price, divBase.id);
    });
    ...
    btnDelet.addEventListener(
        'click',
        function () {
            deletItem(divBase.id);
        },
        false
    );
...
function addCap1() {
    divItemCartList.appendChild(createItemForCart('1', 'cap1', 9.99));
}
function addCap2() {
    divItemCartList.appendChild(createItemForCart('2', 'cap2', 10.99));
}
function addCap3() {
    divItemCartList.appendChild(createItemForCart('3', 'cap3', 7.99));
}
function addCoat1() {
    divItemCartList.appendChild(createItemForCart('1', 'coat1', 34.99));
}
function addCoat2() {
    divItemCartList.appendChild(createItemForCart('2', 'coat2', 39.99));
}
function addGloves1() {
    divItemCartList.appendChild(createItemForCart('1', 'gloves1', 9.99));
}
function addGloves2() {
    divItemCartList.appendChild(createItemForCart('2', 'gloves2', 6.99));
}
function addPullover1() {
    divItemCartList.appendChild(createItemForCart('1', 'pullover1', 16.99));
}
function addPullover2() {
    divItemCartList.appendChild(createItemForCart('2', 'pullover2', 21.99));
}
function addShoes1() {
    divItemCartList.appendChild(createItemForCart('1', 'shoes1', 25.99));
}
function addTrousers1() {
    divItemCartList.appendChild(createItemForCart('1', 'trousers1', 15.99));
}
function addTrousers2() {
    divItemCartList.appendChild(createItemForCart('2', 'trousers2', 18.99));
}
function addTrousers3() {
    divItemCartList.appendChild(createItemForCart('3', 'trousers3', 30.99));
}
